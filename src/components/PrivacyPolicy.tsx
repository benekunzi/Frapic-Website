...
This Privacy Notice for Frapic ("we," "us," or "our"), describes how and why we might access, collect, store, use, and/or share ("process") your personal information when you use our services ("Services"), including when you:

- Download and use our mobile application (Frapic), or any other application of ours that links to this Privacy Notice
...
Fraud prevention provider details: Fingerprint Pro acts as our service provider/data processor for device intelligence processing. We remain the data controller for how this data is used in Frapic.
...
The Services may link to third-party websites, online services, or mobile applications and/or contain advertisements from third parties that are not affiliated with us and which may link to other websites, services, or applications. We do not make any guarantee regarding any such third parties.

6. HOW DO WE HANDLE YOUR SOCIAL LOGINS?

In Short: If you choose to register or log in to our Services using a social media account, we may have access to certain information about you.

Our Services offer you the ability to register and log in using your third-party social media account details. We will use the information we receive only for the purposes that are described in this Privacy Notice or otherwise made clear to you.
...
- B. Personal information as defined in the California Customer Records statute - Collected: NO
...
California Civil Code Section 1798.83, also known as the "Shine The Light" law, permits our users who are California residents to request and obtain from us information about categories of personal information (if any) we disclosed to third parties for direct marketing purposes.
