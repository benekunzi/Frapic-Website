export const translations = {
    ...
    de: {
        ...
        hero: {
            ...
            subtitle: "Frapic ist die kostenlose Social-Media-App nur für deine engsten Freunde. Teile Erinnerungen als Fotos, Stories & Journals – standardmäßig privat, kein Algorithmus, keine Fremden.",
        },
        formats: {
        ...
        manifesto: {
            ...
            description: "Frapic wurde von Grund auf anders konzipiert. Kein Feed, der dich zum endlosen Scrollen verleitet. Keine Fremden, die entscheiden, was viral geht. Kein Algorithmus, der Engagement über echte Verbindungen stellt.",
            noItems: [
                "Kein Algorithmus",
                "Kein endloser Feed",
                "Keine Fremden",
